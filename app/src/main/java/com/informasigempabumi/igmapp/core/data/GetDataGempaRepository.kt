...
class GetDataGempaRepository(private val remoteDataSource: RemoteDataSource): IGetDataGempaRespository {
    ...
    companion object{
        ...
        fun getInstance(remote: RemoteDataSource): GetDataGempaRepository =
            INSTANCE ?: synchronized(this){
                INSTANCE ?: GetDataGempaRepository(remote)
            }
    }
}